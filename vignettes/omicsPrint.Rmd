...
Alternatively, the IDAT-files can be downloaded. 
		
```{r, downloadidats, eval=FALSE}
getGEOSuppFiles("GSE100940")
```
...
data <- alleleSharing(dnamCalls, relations = r, verbose = FALSE)
mismatches <- inferRelations(data)
mismatches
```
