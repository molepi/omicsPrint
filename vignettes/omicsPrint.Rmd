...
library(GEOquery)
library(SummarizedExperiment)
##gset <- getGEO("GSE100940", GSEMatrix=TRUE, AnnotGPL=FALSE)
...
file <- "/home/maarten/Downloads/GSE100940_series_matrix.txt.gz"
gse <- getGEO(filename=file, GSEMatrix=TRUE, AnnotGPL=FALSE)
gse
```
...
```{r allelesharing, dpi = 72, fig.retina = 1, fig.cap="Scatter-plot of IBS mean and variance with classification boundaries. For pairwise comparison between samples consiting of pairs of monozygotic twins."}
