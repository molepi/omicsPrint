Here we will show how you could verify the sample relationship on publicly available DNA methylation data, often a beta-value matrix from the Gene Expression Omnibus.
